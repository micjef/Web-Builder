...
const MenuBar = ({ className, ...props }) => {
  ...
  const classAll = clsx(className, classes.menu);
  return (
    <div {...props} className={classAll}>
      <Button
        color="primary"
        variant="outlined"
      ...
      <a hidden={true} download={true} href={htmlLink} ref={exporterHTML} />
      <a hidden={true} download={true} href={cssLink} ref={exporterCSS} />
    </div>
  );
};
