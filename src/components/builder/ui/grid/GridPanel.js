...
const GridPanel = ({ id }) => {
  ...
  const handleBreakpoint = (event) => setBreakpoint(event.target.value);
  ...
  return (
    <div>
      <div className={classes.field}>
        <label htmlFor="container" className={classes.label}>
          Container?
        </label>
      ...
      {editor.props.item && (
        <React.Fragment>
          <div className={classes.field}>
            <label htmlFor="xs" className={classes.label}>
              Extra Small Size
            </label>
            <TextField
              variant="outlined"
          ...
          <div className={classes.field}>
            <label htmlFor="sm" className={classes.label}>
              Small Size
            </label>
            <TextField
              variant="outlined"
          ...
          <div className={classes.field}>
            <label htmlFor="md" className={classes.label}>
              Medium Size
            </label>
            <TextField
              variant="outlined"
          ...
          <div className={classes.field}>
            <label htmlFor="lg" className={classes.label}>
              Large Size
            </label>
            <TextField
              variant="outlined"
          ...
          <div className={classes.field}>
            <label htmlFor="xl" className={classes.label}>
              Extra Large Size
            </label>
            <TextField
              variant="outlined"
      ...
      <div className={classes.field}>
        <label htmlFor="breakpoint" className={classes.label}>
          Breakpoint Styling
        </label>
        <Select
          native={true}
