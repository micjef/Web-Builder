...
const ButtonPanel = ({ id }) => {
  ...
  const handleAsLink = (event) => setHasLink(event.target.checked);
  ...
  return (
    <div>
      ...
      <div className={classes.field}>
        <label htmlFor="variant" className={classes.label}>
          Fill
        </label>
        <Select
          variant="outlined"
      ...
      <div className={classes.field}>
        <label htmlFor="has_link" className={classes.label}>
          Link?
        </label>
        <span className={classes.input}>
          <Checkbox id="has_link" checked={hasLink} onChange={handleAsLink} />
        </span>
      </div>
      {hasLink && (
        <React.Fragment>
          <div className={classes.field}>
            <label htmlFor="href" className={classes.label}>
              Button Link
            </label>
            <TextField
              variant="outlined"
